...
## sql is choose for e comerce becouse strong acid property support 
 strong structure and relation data
 complex query and join
 transections are critical all must succeed or fail  together sql guarentee this


## no sql is massive scal - instagram handle billions of post likes and comment 
unstructured semi structure data - all post can have llike share comment not always same
high read write throughput - millions of peaople like post same time
eventual consistency is accepatable - if you like your friend post that will show to your friend after some time
